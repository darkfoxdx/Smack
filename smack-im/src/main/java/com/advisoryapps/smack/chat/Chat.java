...
package com.advisoryapps.smack.chat;
 ...
 *
 * @author Matt Tucker
 * @deprecated use <code>com.advisoryapps.smack.chat2.Chat</code> from <code>smack-extensions</code> instead.
 */
@Deprecated
public class Chat {
    ...
    /**
     * Creates a {@link com.advisoryapps.smack.StanzaCollector} which will accumulate the Messages
