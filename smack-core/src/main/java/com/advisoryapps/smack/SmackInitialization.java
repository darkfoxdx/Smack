...
public final class SmackInitialization {
    ...
    static {
        String smackVersion;
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(FileUtils.getStreamForClasspathFile("com.advisoryapps.smack/version", null), StringUtils.UTF8));
