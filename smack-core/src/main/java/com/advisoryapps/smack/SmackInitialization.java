...
import com.advisoryapps.smack.compress.provider.CompressedProvider;
import com.advisoryapps.smack.compress.provider.FailureProvider;
import com.advisoryapps.smack.compression.Java7ZlibInputOutputStream;
import com.advisoryapps.smack.compression.XmppCompressionManager;
import com.advisoryapps.smack.compression.zlib.ZlibXmppCompressionFactory;
import com.advisoryapps.smack.initializer.SmackInitializer;
import com.advisoryapps.smack.packet.Bind;
import com.advisoryapps.smack.packet.Message.Body;
import com.advisoryapps.smack.provider.BindIQProvider;
import com.advisoryapps.smack.provider.BodyElementProvider;
import com.advisoryapps.smack.provider.ProviderManager;
import com.advisoryapps.smack.provider.TlsFailureProvider;
import com.advisoryapps.smack.provider.TlsProceedProvider;
import com.advisoryapps.smack.sasl.core.SASLAnonymous;
import com.advisoryapps.smack.sasl.core.SASLXOauth2Mechanism;
import com.advisoryapps.smack.sasl.core.SCRAMSHA1Mechanism;
import com.advisoryapps.smack.sasl.core.ScramSha1PlusMechanism;
...
public final class SmackInitialization {
    ...
    private static final String DEFAULT_CONFIG_FILE = "com.advisoryapps.smack/smack-config.xml";
    ...
    static {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(FileUtils.getStreamForClasspathFile("com.advisoryapps.smack/version", null), StandardCharsets.UTF_8));
