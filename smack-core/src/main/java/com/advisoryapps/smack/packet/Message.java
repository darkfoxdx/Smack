...
import com.advisoryapps.smack.util.TypedCloneable;
...
public final class Message extends Stanza implements TypedCloneable<Message> {
     ...
     * com.advisoryapps.smack.packet.Message.Type#normal}.
     *
     ...
     * @return the new {@link com.advisoryapps.smack.packet.Message.Subject}
     ...
     * @return the new {@link com.advisoryapps.smack.packet.Message.Body}
