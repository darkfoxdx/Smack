...
import static com.advisoryapps.smack.util.StringUtils.requireNotNullNorEmpty;
...
import com.advisoryapps.smack.packet.id.StanzaIdUtil;
...
public abstract class Stanza implements TopLevelStreamElement {
     ...
     * @deprecated use {@link #setError(com.advisoryapps.smack.packet.StanzaError.Builder)} instead.
     */
    @Deprecated
