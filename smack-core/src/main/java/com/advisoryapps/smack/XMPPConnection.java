...
public interface XMPPConnection {
    ...
    */
     ...
     * {@link com.advisoryapps.smack.packet.IQ.Type#result} with that result IQ. The callback will
    ...
    /**
     * Send a IQ stanza and invoke <code>callback</code> if there is a result of
     * {@link com.advisoryapps.smack.packet.IQ.Type#result} with that result IQ. If there is an
    ...
    /**
     * Convenience method for {@link #unregisterIQRequestHandler(String, String, com.advisoryapps.smack.packet.IQ.Type)}.
     *
