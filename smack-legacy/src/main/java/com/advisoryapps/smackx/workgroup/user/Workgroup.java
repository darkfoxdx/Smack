 ...
 */
package com.advisoryapps.smackx.workgroup.user;
...
import com.advisoryapps.smackx.workgroup.ext.forms.WorkgroupForm;
import com.advisoryapps.smackx.workgroup.packet.DepartQueuePacket;
import com.advisoryapps.smackx.workgroup.packet.QueueUpdate;
import com.advisoryapps.smackx.workgroup.packet.SessionID;
import com.advisoryapps.smackx.workgroup.packet.UserID;
import com.advisoryapps.smackx.workgroup.settings.ChatSetting;
import com.advisoryapps.smackx.workgroup.settings.ChatSettings;
import com.advisoryapps.smackx.workgroup.settings.OfflineSettings;
import com.advisoryapps.smackx.workgroup.settings.SoundSettings;
import com.advisoryapps.smackx.workgroup.settings.WorkgroupProperties;
...
public class Workgroup {
    ...
    public Workgroup(EntityBareJid workgroupJID, XMPPConnection connection) {
        ...
        MultiUserChatManager.getInstanceFor(connection).addInvitationListener(
                new com.advisoryapps.smackx.muc.InvitationListener() {
                    @Override
                    public void invitationReceived(XMPPConnection conn, com.advisoryapps.smackx.muc.MultiUserChat room, EntityJid inviter,
