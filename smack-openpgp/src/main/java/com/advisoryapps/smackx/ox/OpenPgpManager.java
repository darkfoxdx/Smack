...
import static com.advisoryapps.smackx.ox.util.OpenPgpPubSubUtil.PEP_NODE_PUBLIC_KEYS;
import static com.advisoryapps.smackx.ox.util.OpenPgpPubSubUtil.PEP_NODE_PUBLIC_KEYS_NOTIFY;
import static com.advisoryapps.smackx.ox.util.OpenPgpPubSubUtil.publishPublicKey;
...
import com.advisoryapps.smack.chat2.IncomingChatMessageListener;
...
import com.advisoryapps.smackx.ox.callback.backup.AskForBackupCodeCallback;
import com.advisoryapps.smackx.ox.callback.backup.DisplayBackupCodeCallback;
import com.advisoryapps.smackx.ox.callback.backup.SecretKeyBackupSelectionCallback;
import com.advisoryapps.smackx.ox.crypto.OpenPgpProvider;
import com.advisoryapps.smackx.ox.element.CryptElement;
import com.advisoryapps.smackx.ox.element.OpenPgpContentElement;
...
import com.advisoryapps.smackx.ox.exception.InvalidBackupCodeException;
import com.advisoryapps.smackx.ox.exception.MissingOpenPgpKeyException;
import com.advisoryapps.smackx.ox.exception.MissingUserIdOnKeyException;
import com.advisoryapps.smackx.ox.exception.NoBackupFoundException;
import com.advisoryapps.smackx.ox.listener.CryptElementReceivedListener;
import com.advisoryapps.smackx.ox.listener.SignElementReceivedListener;
import com.advisoryapps.smackx.ox.listener.SigncryptElementReceivedListener;
import com.advisoryapps.smackx.ox.store.definition.OpenPgpStore;
import com.advisoryapps.smackx.ox.store.definition.OpenPgpTrustStore;
import com.advisoryapps.smackx.ox.util.OpenPgpPubSubUtil;
import com.advisoryapps.smackx.ox.util.SecretKeyBackupHelper;
...
public final class OpenPgpManager extends Manager {
    ...
    /**
     * Throw a {@link com.advisoryapps.smack.SmackException.NotLoggedInException} if the {@link XMPPConnection} of this
