...
import com.advisoryapps.smackx.jingleold.nat.ICECandidate;
...
public class JingleTransport implements ExtensionElement {
    ...
    public static class Ice extends JingleTransport {
         ...
         *
         * @see com.advisoryapps.smackx.jingleold.packet.JingleTransport#addCandidate(com.advisoryapps.smackx.jingleold.packet.JingleTransport.JingleTransportCandidate)
         */
        @Override
        public void addCandidate(final JingleTransportCandidate candidate) {
         ...
         *
         * @see com.advisoryapps.smackx.jingleold.packet.JingleTransport#getCandidates()
         */
        @Override
        public List<JingleTransportCandidate> getCandidatesList() {
