 ...
 */
package com.advisoryapps.smack.extensions;
...
public class ExtensionsInitializer extends UrlInitializer {
    ...
    protected String getProvidersUri() {
        return "classpath:com.advisoryapps.smack.extensions/extensions.providers";
    }

    @Override
    protected String getConfigUri() {
        return "classpath:com.advisoryapps.smack.extensions/extensions.xml";
    }
}
