...
import com.advisoryapps.smackx.pubsub.provider.ItemProvider;
 ...
 *
 * <h3>An Item received from a node (via {@link LeafNode#getItems()} or {@link LeafNode#addItemEventListener(com.advisoryapps.smackx.pubsub.listener.ItemEventListener)}</h3>
 * <ul>
